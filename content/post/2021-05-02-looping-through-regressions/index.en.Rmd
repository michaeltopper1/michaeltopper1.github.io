...
In this case, I am estimating a linear probability model on the outcome $Survived_i$ (whether or not person $i$ survived the titanic). Note that $Female_i$ (a binary variable equal to 1 if passenger $i$ is a female), $FirstClass_i$, and $SecondClass_i$ are not columns in the data, so we're going to need to create these:
